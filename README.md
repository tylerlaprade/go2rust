...
| └ Range stdlib-interface slice values passed to functions and assigned into interface vars | ✅ |
| └ Range over integers | ✅ |
| **`func` - Functions** | |
| └ Basic functions | ✅ |
...
| └ Range stdlib-interface slice values used in calls and assignments | ✅ |
| └ Channel range | ✅ |
