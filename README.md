...
| └ Function parameters forwarded to function/method parameters | ✅ |
...
| └ Stdlib interface range values used in slice literals | ✅ |
...
| └ Concrete values in named-interface map literals box into interface value slots | ✅ |
