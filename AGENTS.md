...
- Prefer `./test.sh -n 6 -t 30s` for full-suite validation when the machine has memory headroom; on 2026-05-11 it completed 454 passing fixtures plus 10 XFAIL in 180s. Drop to `-n 4` if timer fixtures starve or the machine is under visible pressure.
