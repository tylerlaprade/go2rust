...
- ✅ Closures and function literals - type-info-scoped capture analysis handles nested closures, package selectors, type conversions, Rust keyword parameters, keyed struct literal fields, and recursive function-variable closure assignment (closure_struct_literal_field_keys added, 2026-05-10)
