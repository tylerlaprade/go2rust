...
- ✅ Range stdlib-interface slice values - range values from slices such as `[]ast.Stmt` clone the stub value out of iterator references when passed to same-interface parameters or assigned into interface variables (range_stdlib_interface_slice_call added, 2026-05-12)
