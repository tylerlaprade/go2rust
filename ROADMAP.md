...
- ✅ Byte/rune comparison contexts - character literals emit as `u8` when compared with `byte` values or string indexing results, and remain Rust `char` literals when compared with string-range rune values (byte_char_comparisons promoted, 2026-05-07; strings_runes expanded, 2026-05-10)
