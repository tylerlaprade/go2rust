...
- ✅ Named iota enum types - iota-backed defined integer types preserve newtype semantics across constants, switch cases, maps, returns, and String methods (enums_iota promoted, 2026-05-06)
