...
- ✅ Named iota enum types - iota-backed defined integer types preserve newtype semantics across constants, switch cases, maps, returns, struct fields, and String methods (enums_iota promoted, 2026-05-06; struct_const_fields promoted, 2026-05-07)
