...
- ✅ Selector map field access - `delete(h.table, key)`, comma-ok reads, ordinary reads, range over selector map fields, and wrapped map range values used as lookup/delete keys borrow or unwrap the correct Rust map/key representation instead of treating handles as bare values (concurrent_selector_map_lookup expanded, 2026-05-10; string_map_parameter_keys and map_range_value_delete_key added, 2026-05-10)
