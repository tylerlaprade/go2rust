...
pub mod bytealg {
    ...
    pub fn make_no_zero<T0>(_arg0: T0) -> Arc<Mutex<Option<Vec<u8>>>> {
        panic!("make_no_zero bridge: generic stub function body has no implementation; add a custom emitter or remove the call — see AGENTS.md 'Strategy: Transpile stdlib, don't bridge it' and docs/bridge_debt.md")
    }
}
...
pub mod stringslite {
    ...
    pub fn index<T0, T1>(_arg0: T0, _arg1: T1) -> i32 {
