...
pub type handler = Rc<RefCell<Option<Box<dyn FnMut(Rc<RefCell<Option<i32>>>) -> i32>>>>;
...
pub type ptrHandler = Rc<RefCell<Option<Box<dyn FnMut(Rc<RefCell<Option<item>>>) -> i32>>>>;
...
pub(crate) static handlers: GoGlobal<BTreeMap<String, Rc<RefCell<Option<Box<dyn FnMut(Rc<RefCell<Option<i32>>>) -> i32>>>>>> = GoGlobal::new();

pub(crate) static ptrHandlers: GoGlobal<BTreeMap<String, Rc<RefCell<Option<Box<dyn FnMut(Rc<RefCell<Option<item>>>) -> i32>>>>>> = GoGlobal::new();
...
fn __go_init_0() {
    { let new_val = { let __collection_holder = Rc::new(RefCell::new(Some(BTreeMap::<String, Rc<RefCell<Option<Box<dyn FnMut(Rc<RefCell<Option<i32>>>) -> i32>>>>>::from([("inc".to_string(), Rc::new(RefCell::new(Some(Box::new(move |__arg0: Rc<RefCell<Option<i32>>>| -> i32 { inc(__arg0) }) as Box<dyn FnMut(Rc<RefCell<Option<i32>>>) -> i32>)))), ("twice".to_string(), Rc::new(RefCell::new(Some(Box::new(move |__arg0: Rc<RefCell<Option<i32>>>| -> i32 { twice(__arg0) }) as Box<dyn FnMut(Rc<RefCell<Option<i32>>>) -> i32>))))])))).clone(); let __collection_guard = __collection_holder.borrow(); (*__collection_guard).clone() }; *handlers.borrow_mut() = new_val; };
    { let new_val = { let __collection_holder = Rc::new(RefCell::new(Some(BTreeMap::<String, Rc<RefCell<Option<Box<dyn FnMut(Rc<RefCell<Option<item>>>) -> i32>>>>>::from([("read".to_string(), Rc::new(RefCell::new(Some(Box::new(move |__arg0: Rc<RefCell<Option<item>>>| -> i32 { read(__arg0) }) as Box<dyn FnMut(Rc<RefCell<Option<item>>>) -> i32>))))])))).clone(); let __collection_guard = __collection_holder.borrow(); (*__collection_guard).clone() }; *ptrHandlers.borrow_mut() = new_val; };
}
