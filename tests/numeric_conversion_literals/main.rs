...
fn main() {
    ...
    println!("{} {}", format!("{}", "uint64 literal mask:".to_string()), format!("{}", uint64_mask(Rc::new(RefCell::new(Some(5 as u32))))));
    println!("{} {}", format!("{}", "byte expression:".to_string()), format!("{}", byte_from_expr(Rc::new(RefCell::new(Some(4 as u8))))));
}