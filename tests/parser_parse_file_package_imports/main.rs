...
fn main() {
    ...
    let (mut file, mut err) = parser::parse_file(fset.clone(), "input.go".to_string(), "package main\n\nimport (\n\t\"fmt\"\n\talias \"strings\"\n\t_ \"os\"\n)\n".to_string(), { let __go_arg = parser::IMPORTS_ONLY; __go_arg });
    println!("{} {} {}", format!("{}", (*err.lock().unwrap()).is_none()), format!("{}", (*(*(*file.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).clone()), format!("{}", (*(*file.lock().unwrap().as_ref().unwrap()).imports.lock().unwrap()).as_ref().map(|__v| __v.len()).unwrap_or(0)));
    println!("{}", format!("{}", (*(*(*{ let __seq = { let __seq_holder = (*file.lock().unwrap().as_ref().unwrap()).imports.clone(); let __seq_guard = __seq_holder.lock().unwrap(); let __cloned = (*__seq_guard.as_ref().unwrap()).clone(); drop(__seq_guard); __cloned }; __seq[(0) as usize].clone() }.lock().unwrap().as_ref().unwrap()).path.lock().unwrap().as_ref().unwrap()).value.lock().unwrap().as_ref().unwrap()).clone()));
    println!("{} {}", format!("{}", (*(*(*{ let __seq = { let __seq_holder = (*file.lock().unwrap().as_ref().unwrap()).imports.clone(); let __seq_guard = __seq_holder.lock().unwrap(); let __cloned = (*__seq_guard.as_ref().unwrap()).clone(); drop(__seq_guard); __cloned }; __seq[(1) as usize].clone() }.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).clone()), format!("{}", (*(*(*{ let __seq = { let __seq_holder = (*file.lock().unwrap().as_ref().unwrap()).imports.clone(); let __seq_guard = __seq_holder.lock().unwrap(); let __cloned = (*__seq_guard.as_ref().unwrap()).clone(); drop(__seq_guard); __cloned }; __seq[(1) as usize].clone() }.lock().unwrap().as_ref().unwrap()).path.lock().unwrap().as_ref().unwrap()).value.lock().unwrap().as_ref().unwrap()).clone()));
    println!("{} {}", format!("{}", (*(*(*{ let __seq = { let __seq_holder = (*file.lock().unwrap().as_ref().unwrap()).imports.clone(); let __seq_guard = __seq_holder.lock().unwrap(); let __cloned = (*__seq_guard.as_ref().unwrap()).clone(); drop(__seq_guard); __cloned }; __seq[(2) as usize].clone() }.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).clone()), format!("{}", (*(*(*{ let __seq = { let __seq_holder = (*file.lock().unwrap().as_ref().unwrap()).imports.clone(); let __seq_guard = __seq_holder.lock().unwrap(); let __cloned = (*__seq_guard.as_ref().unwrap()).clone(); drop(__seq_guard); __cloned }; __seq[(2) as usize].clone() }.lock().unwrap().as_ref().unwrap()).path.lock().unwrap().as_ref().unwrap()).value.lock().unwrap().as_ref().unwrap()).clone()));
}