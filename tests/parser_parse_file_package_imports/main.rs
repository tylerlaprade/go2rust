...
fn main() {
    ...
    println!("{} {} {}", format!("{}", (*err.lock().unwrap()).is_none()), format!("{}", (*(*(*file.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap()).name.lock().unwrap().as_ref().unwrap())), format!("{}", (*(*file.lock().unwrap().as_ref().unwrap()).imports.lock().unwrap().as_ref().unwrap()).len()));
