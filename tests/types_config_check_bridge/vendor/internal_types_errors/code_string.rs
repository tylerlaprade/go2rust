...
impl crate::codes::Code {
    pub fn string(&self) -> Arc<Mutex<Option<String>>> {
        ...
        if { let __tmp_x = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = crate::codes::Code(Arc::new(Mutex::new(Some(-1 as i32)))); __tmp_x == __tmp_y } {
            return Arc::new(Mutex::new(Some(__CODE_NAME_0.to_string())));
        } else if { let __tmp_x = crate::codes::Code(Arc::new(Mutex::new(Some(1 as i32)))); let __tmp_y = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); __tmp_x <= __tmp_y } && { let __tmp_x = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = crate::codes::Code(Arc::new(Mutex::new(Some(28 as i32)))); __tmp_x <= __tmp_y } {
        ...
        } else if { let __tmp_x = crate::codes::Code(Arc::new(Mutex::new(Some(30 as i32)))); let __tmp_y = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); __tmp_x <= __tmp_y } && { let __tmp_x = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = crate::codes::Code(Arc::new(Mutex::new(Some(79 as i32)))); __tmp_x <= __tmp_y } {
        ...
        } else if { let __tmp_x = crate::codes::Code(Arc::new(Mutex::new(Some(81 as i32)))); let __tmp_y = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); __tmp_x <= __tmp_y } && { let __tmp_x = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = crate::codes::Code(Arc::new(Mutex::new(Some(106 as i32)))); __tmp_x <= __tmp_y } {
        ...
        } else if { let __tmp_x = crate::codes::Code(Arc::new(Mutex::new(Some(108 as i32)))); let __tmp_y = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); __tmp_x <= __tmp_y } && { let __tmp_x = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = crate::codes::Code(Arc::new(Mutex::new(Some(146 as i32)))); __tmp_x <= __tmp_y } {
        ...
        } else if { let __tmp_x = crate::codes::Code(Arc::new(Mutex::new(Some(148 as i32)))); let __tmp_y = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); __tmp_x <= __tmp_y } && { let __tmp_x = (*__self.0.lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = crate::codes::Code(Arc::new(Mutex::new(Some(151 as i32)))); __tmp_x <= __tmp_y } {
