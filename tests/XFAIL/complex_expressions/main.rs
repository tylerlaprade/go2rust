fn main() {
    ...
    let mut chanResult = <-ch + <-ch * 2 - <-ch / 2;
    ...
    let (mut sum, mut product) = (a + b + c, a * b * c);
    print!("Sum: {}, Product: {}\n", sum, product);
