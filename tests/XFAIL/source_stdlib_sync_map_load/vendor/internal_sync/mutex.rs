...
impl Mutex {
    ...
    pub fn lock_slow(&self) {
        ...
        let mut delta = Arc::new(StdMutex::new(Some(({ let __tmp_x = MUTEX_LOCKED; let __tmp_y = { let __tmp_x = 1; let __tmp_y = MUTEX_WAITER_SHIFT; __tmp_x << __tmp_y }; __tmp_x - __tmp_y }) as i32)));
