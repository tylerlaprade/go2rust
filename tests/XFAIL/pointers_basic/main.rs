...
fn main() {
    ...
    println!("{} {}", "Point X:".to_string(), (*(*point.lock().unwrap().as_mut().unwrap()).x.lock().unwrap().as_ref().unwrap()));
    println!("{} {}", "Point Y:".to_string(), (*(*point.lock().unwrap().as_mut().unwrap()).y.lock().unwrap().as_ref().unwrap()));
