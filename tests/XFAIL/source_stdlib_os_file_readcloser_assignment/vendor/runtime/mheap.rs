...
pub struct mheap {
    ...
    pub allspans: Arc<Mutex<Option<Vec<Arc<Mutex<Option<mspan>>>>>>>,
...
pub struct mspan {
    ...
    pub large_type: Arc<Mutex<Option<internal_abi::r#type::Type>>>,
}
...
impl mheap {
    ...
    pub fn grow(&mut self, npage: Arc<Mutex<Option<usize>>>) -> (usize, bool) {
        ...
        let (mut av, mut asize) = { let __method_arg0 = Arc::new(Mutex::new(Some({ let __arg_holder = ask.clone(); let __arg_guard = __arg_holder.lock().unwrap(); (*__arg_guard.as_ref().unwrap()).clone() }))); let __method_arg1 = Arc::new(Mutex::new(Some(self.arena_hints.clone()))); let __method_arg2 = Arc::new(Mutex::new(Some(true))); self.sys_alloc(__method_arg0, __method_arg1, __method_arg2) };
...
impl mSpanList {
    ...
    pub fn remove(&mut self, span: GoPtr<mspan>) {
        ...
        eprint!("{}{}{}{}{}{}{}{}{}{}{}", format!("{}", "runtime: failed mSpanList.remove span.npages=".to_string()), format!("{}", (*{ let __ptr_value = span.borrow(); __ptr_value.as_ref().unwrap().npages.clone() }.lock().unwrap().as_ref().unwrap())), format!("{}", " span=".to_string()), format!("{}", format!("&{}", (*span.lock().unwrap().as_ref().unwrap()))), format!("{}", " prev=".to_string()), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.prev.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))), format!("{}", " span.list=".to_string()), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.list.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))), format!("{}", " list=".to_string()), format!("{}", format!("{:p}", self)), format!("{}", "\n".to_string()));
    ...
    pub fn insert(&mut self, span: GoPtr<mspan>) {
        ...
        eprintln!("{} {} {} {} {}", format!("{}", "runtime: failed mSpanList.insert".to_string()), format!("{}", format!("&{}", (*span.lock().unwrap().as_ref().unwrap()))), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.next.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.prev.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.list.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))));
    ...
    pub fn insert_back(&mut self, span: GoPtr<mspan>) {
        if { let __ptr_field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.next.clone()); __ptr_value }.clone(); !__ptr_field.is_nil() } || { let __ptr_field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.prev.clone()); __ptr_value }.clone(); !__ptr_field.is_nil() } || { let __nil_target = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.list.clone()); __ptr_value }.clone(); let __nil_result = (*__nil_target.lock().unwrap()).is_some(); __nil_result } {
        eprintln!("{} {} {} {} {}", format!("{}", "runtime: failed mSpanList.insertBack".to_string()), format!("{}", format!("&{}", (*span.lock().unwrap().as_ref().unwrap()))), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.next.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.prev.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))), format!("{}", format!("&{}", (*{ let __field = { let __ptr_value = span.with_mut(|__ptr_value| __ptr_value.list.clone()); __ptr_value }.clone(); __field }.lock().unwrap().as_ref().unwrap()))));
...
pub fn recordspan(vh: Arc<Mutex<Option<usize>>>, p: Arc<Mutex<Option<usize>>>) {
    ...
    if { let __tmp_x = (({ let __len_target = { let __field = { let __ptr_value = h.with_mut(|__ptr_value| __ptr_value.allspans.clone()); __ptr_value }.clone(); __field }; let __len_guard = __len_target.lock().unwrap(); __len_guard.as_ref().map(|__v| __v.len()).unwrap_or(0) }) as i32); let __tmp_y = (({ let __cap_target = { let __field = { let __ptr_value = h.with_mut(|__ptr_value| __ptr_value.allspans.clone()); __ptr_value }.clone(); __field }; let __cap_guard = __cap_target.lock().unwrap(); __cap_guard.as_ref().map(|__v| __v.capacity()).unwrap_or(0) }) as i32); __tmp_x >= __tmp_y } {
        ...
        let mut new: Arc<Mutex<Option<Vec<Arc<Mutex<Option<mspan>>>>>>> = Arc::new(Mutex::new(None));
