...
fn __go_init_globals() {
    ...
    *sigtable.lock().unwrap() = Some((*Arc::new(Mutex::new(Some([crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(0 as i32))), name: Arc::new(Mutex::new(Some("SIGNONE: no trap".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_KILL; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGHUP: terminal line hangup".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_KILL; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGINT: interrupt".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_THROW; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGQUIT: quit".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_THROW; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGILL: illegal instruction".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_THROW; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGTRAP: trace trap".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_THROW; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGABRT: abort".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_THROW as i32))), name: Arc::new(Mutex::new(Some("SIGEMT: emulate instruction executed".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_PANIC; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGFPE: floating-point exception".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(0 as i32))), name: Arc::new(Mutex::new(Some("SIGKILL: kill".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_PANIC; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGBUS: bus error".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_PANIC; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGSEGV: segmentation violation".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_THROW as i32))), name: Arc::new(Mutex::new(Some("SIGSYS: bad system call".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGPIPE: write to broken pipe".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGALRM: alarm clock".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_KILL; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGTERM: termination".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGURG: urgent condition on socket".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(0 as i32))), name: Arc::new(Mutex::new(Some("SIGSTOP: stop".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_DEFAULT; __tmp_x + __tmp_y }; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGTSTP: keyboard stop".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_DEFAULT; __tmp_x + __tmp_y }; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGCONT: continue after stop".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y }; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGCHLD: child status has changed".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_DEFAULT; __tmp_x + __tmp_y }; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGTTIN: background read from tty".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_DEFAULT; __tmp_x + __tmp_y }; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGTTOU: background write to tty".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGIO: i/o now possible".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGXCPU: cpu limit exceeded".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGXFSZ: file size limit exceeded".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGVTALRM: virtual alarm clock".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_UNBLOCK; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGPROF: profiling alarm clock".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGWINCH: window size change".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some({ let __tmp_x = __SIG_NOTIFY; let __tmp_y = __SIG_IGN; __tmp_x + __tmp_y } as i32))), name: Arc::new(Mutex::new(Some("SIGINFO: status request from keyboard".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGUSR1: user-defined signal 1".to_string()))), ..Default::default() }, crate::signal_unix::sigTabT { flags: Arc::new(Mutex::new(Some(__SIG_NOTIFY as i32))), name: Arc::new(Mutex::new(Some("SIGUSR2: user-defined signal 2".to_string()))), ..Default::default() }]))).lock().unwrap().as_ref().unwrap()).clone());
}
