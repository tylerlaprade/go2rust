...
fn __go_init_globals() {
    ...
    *All.lock().unwrap() = Some((*Arc::new(Mutex::new(Some(vec![Info { name: Arc::new(Mutex::new(Some("allowmultiplevcs".to_string()))), package: Arc::new(Mutex::new(Some("cmd/go".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("asynctimerchan".to_string()))), package: Arc::new(Mutex::new(Some("time".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("dataindependenttiming".to_string()))), package: Arc::new(Mutex::new(Some("crypto/subtle".to_string()))), opaque: Arc::new(Mutex::new(Some(true))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("execerrdot".to_string()))), package: Arc::new(Mutex::new(Some("os/exec".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("fips140".to_string()))), package: Arc::new(Mutex::new(Some("crypto/fips140".to_string()))), opaque: Arc::new(Mutex::new(Some(true))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("gocachehash".to_string()))), package: Arc::new(Mutex::new(Some("cmd/go".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("gocachetest".to_string()))), package: Arc::new(Mutex::new(Some("cmd/go".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("gocacheverify".to_string()))), package: Arc::new(Mutex::new(Some("cmd/go".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("gotestjsonbuildtext".to_string()))), package: Arc::new(Mutex::new(Some("cmd/go".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("gotypesalias".to_string()))), package: Arc::new(Mutex::new(Some("go/types".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("http2client".to_string()))), package: Arc::new(Mutex::new(Some("net/http".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("http2debug".to_string()))), package: Arc::new(Mutex::new(Some("net/http".to_string()))), opaque: Arc::new(Mutex::new(Some(true))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("http2server".to_string()))), package: Arc::new(Mutex::new(Some("net/http".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("httplaxcontentlength".to_string()))), package: Arc::new(Mutex::new(Some("net/http".to_string()))), changed: Arc::new(Mutex::new(Some(22))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("httpmuxgo121".to_string()))), package: Arc::new(Mutex::new(Some("net/http".to_string()))), changed: Arc::new(Mutex::new(Some(22))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("httpservecontentkeepheaders".to_string()))), package: Arc::new(Mutex::new(Some("net/http".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("installgoroot".to_string()))), package: Arc::new(Mutex::new(Some("go/build".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("jstmpllitinterp".to_string()))), package: Arc::new(Mutex::new(Some("html/template".to_string()))), opaque: Arc::new(Mutex::new(Some(true))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("multipartmaxheaders".to_string()))), package: Arc::new(Mutex::new(Some("mime/multipart".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("multipartmaxparts".to_string()))), package: Arc::new(Mutex::new(Some("mime/multipart".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("multipathtcp".to_string()))), package: Arc::new(Mutex::new(Some("net".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("netdns".to_string()))), package: Arc::new(Mutex::new(Some("net".to_string()))), opaque: Arc::new(Mutex::new(Some(true))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("netedns0".to_string()))), package: Arc::new(Mutex::new(Some("net".to_string()))), changed: Arc::new(Mutex::new(Some(19))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("panicnil".to_string()))), package: Arc::new(Mutex::new(Some("runtime".to_string()))), changed: Arc::new(Mutex::new(Some(21))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("randautoseed".to_string()))), package: Arc::new(Mutex::new(Some("math/rand".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("randseednop".to_string()))), package: Arc::new(Mutex::new(Some("math/rand".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("rsa1024min".to_string()))), package: Arc::new(Mutex::new(Some("crypto/rsa".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tarinsecurepath".to_string()))), package: Arc::new(Mutex::new(Some("archive/tar".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tls10server".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), changed: Arc::new(Mutex::new(Some(22))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tls3des".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tlsmaxrsasize".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tlsmlkem".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("0".to_string()))), opaque: Arc::new(Mutex::new(Some(true))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tlsrsakex".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), changed: Arc::new(Mutex::new(Some(22))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("tlsunsafeekm".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), changed: Arc::new(Mutex::new(Some(22))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("winreadlinkvolume".to_string()))), package: Arc::new(Mutex::new(Some("os".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("winsymlink".to_string()))), package: Arc::new(Mutex::new(Some("os".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("x509keypairleaf".to_string()))), package: Arc::new(Mutex::new(Some("crypto/tls".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("x509negativeserial".to_string()))), package: Arc::new(Mutex::new(Some("crypto/x509".to_string()))), changed: Arc::new(Mutex::new(Some(23))), old: Arc::new(Mutex::new(Some("1".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("x509rsacrt".to_string()))), package: Arc::new(Mutex::new(Some("crypto/x509".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("x509usefallbackroots".to_string()))), package: Arc::new(Mutex::new(Some("crypto/x509".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("x509usepolicies".to_string()))), package: Arc::new(Mutex::new(Some("crypto/x509".to_string()))), changed: Arc::new(Mutex::new(Some(24))), old: Arc::new(Mutex::new(Some("0".to_string()))), ..Default::default() }, Info { name: Arc::new(Mutex::new(Some("zipinsecurepath".to_string()))), package: Arc::new(Mutex::new(Some("archive/zip".to_string()))), ..Default::default() }]))).lock().unwrap().as_ref().unwrap()).clone());
}
