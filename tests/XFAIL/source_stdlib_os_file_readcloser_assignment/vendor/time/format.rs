...
pub fn next_std_chunk(layout: Arc<Mutex<Option<String>>>) -> (Arc<Mutex<Option<String>>>, i32, Arc<Mutex<Option<String>>>) {
    ...
    if _switch_val == (('J' as i32)) {
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
            257,
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 7; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
        );
    }
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
            258,
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 3; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
        );
    }
    }
        ...
        return (
            ...
            if {
                let __go_cond_0 = {
                    let __go_cond_1 = { let __tmp_x = ((*layout.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 2; __tmp_x + __tmp_y } as i32); __tmp_x >= __tmp_y };
                    if __go_cond_1 {
                        let __go_cond_2 = {
                            let __tmp_x = ('1' as i32) as u8;
                            let __tmp_y = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                            __tmp_x <= __tmp_y
                        };
                        __go_cond_2
                    } else {
                ...
                if __go_cond_0 {
                    let __go_cond_3 = {
                        let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                        let __tmp_y = ('6' as i32) as u8;
                        __tmp_x <= __tmp_y
                    };
                    __go_cond_3
                } else {
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
            { let __seq = { let __seq_holder = std0x.clone(); let __seq_guard = __seq_holder.lock().unwrap(); let __cloned = (*__seq_guard.as_ref().unwrap()).clone(); drop(__seq_guard); __cloned }; __seq[({
                let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                let __tmp_y = ('1' as i32) as u8;
                __tmp_x - __tmp_y
            }) as usize].clone() },
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 2; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
        );
    }
            if {
                let __go_cond_0 = {
                    let __go_cond_1 = { let __tmp_x = ((*layout.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 3; __tmp_x + __tmp_y } as i32); __tmp_x >= __tmp_y };
                    if __go_cond_1 {
                        let __go_cond_2 = {
                            let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                ...
                if __go_cond_0 {
                    let __go_cond_3 = {
                        let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 2; __tmp_x + __tmp_y }) as usize] };
                        let __tmp_y = ('2' as i32) as u8;
                        __tmp_x == __tmp_y
                    };
                    __go_cond_3
                } else {
        ...
        return (
            ...
            if {
                let __go_cond_0 = { let __tmp_x = ((*layout.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 2; __tmp_x + __tmp_y } as i32); __tmp_x >= __tmp_y };
                if __go_cond_0 {
                    let __go_cond_1 = {
                        let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                        let __tmp_y = ('5' as i32) as u8;
                        __tmp_x == __tmp_y
                    };
                    __go_cond_1
                } else {
        ...
        return (
            ...
            return (
                Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
                259,
                Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
            );
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
            275,
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 4; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
        );
    }
            return (
                Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize; __s[__low..__high].to_string() }))),
            275,
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 5; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
        );
    }
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
            33,
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 9; __tmp_x + __tmp_y }) as usize; __s[__low..].to_string() })))
        );
    }
        ...
        return (
            ...
            if {
                let __go_cond_0 = { let __tmp_x = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y } as i32); let __tmp_y = ((*layout.lock().unwrap().as_ref().unwrap()).len() as i32); __tmp_x < __tmp_y };
                if __go_cond_0 {
                    let __go_cond_1 = {
                        let __go_cond_2 = {
                            let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
        ...
        while {
            let __go_cond_0 = { let __tmp_x = ({ let __v = (*j.lock().unwrap().as_ref().unwrap()).clone(); __v } as i32); let __tmp_y = ((*layout.lock().unwrap().as_ref().unwrap()).len() as i32); __tmp_x < __tmp_y };
            if __go_cond_0 {
                let __go_cond_1 = {
                    let __tmp_x = { let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __v = (*j.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize] };
                    let __tmp_y = { let __v = (*ch.lock().unwrap().as_ref().unwrap()).clone(); __v };
                    __tmp_x == __tmp_y
                };
                __go_cond_1
            } else {
        ...
        return (
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = (0) as usize; let __high = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..__high].to_string() }))),
            std,
            Arc::new(Mutex::new(Some({ let __s = &((*layout.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __v = (*j.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..].to_string() })))
        );
    }
    }
        }
...
pub fn append_int(mut b: Arc<Mutex<Option<Vec<u8>>>>, x: Arc<Mutex<Option<i32>>>, width: Arc<Mutex<Option<i32>>>) -> Arc<Mutex<Option<Vec<u8>>>> {
    ...
    if { let __tmp_x = { let __v = (*width.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 2; __tmp_x == __tmp_y } && { let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1e2 as u64; __tmp_x < __tmp_y } {
            return { let __append_target = b.clone(); (*__append_target.lock().unwrap()).get_or_insert_with(Vec::new).extend(vec![
                {
                    let __f_ptr: *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync> = {
                        let mut __f_guard = utod.lock().unwrap();
                        __f_guard.as_mut().unwrap() as *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync>
                    };
                    let __f = unsafe { &mut *__f_ptr };
                    (*__f)(
                        Arc::new(Mutex::new(Some({ let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1e1 as u64; __tmp_x / __tmp_y })))
                    )
                },
                {
                    let __f_ptr: *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync> = {
            ...
            return { let __append_target = b.clone(); (*__append_target.lock().unwrap()).get_or_insert_with(Vec::new).extend(vec![
                {
                    ...
                    let __f = unsafe { &mut *__f_ptr };
                    (*__f)(
                        Arc::new(Mutex::new(Some({ let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1e3 as u64; __tmp_x / __tmp_y })))
                    )
                },
                {
                    let __f_ptr: *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync> = {
                    ...
                    let __f = unsafe { &mut *__f_ptr };
                    (*__f)(
                        Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1e2 as u64; __tmp_x / __tmp_y }; let __tmp_y = 1e1 as u64; __tmp_x % __tmp_y })))
                    )
                },
                {
                    let __f_ptr: *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync> = {
                    ...
                    let __f = unsafe { &mut *__f_ptr };
                    (*__f)(
                        Arc::new(Mutex::new(Some({ let __tmp_x = { let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1e1 as u64; __tmp_x / __tmp_y }; let __tmp_y = 1e1 as u64; __tmp_x % __tmp_y })))
                    )
                },
                {
                    let __f_ptr: *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync> = {
    ...
    if { let __tmp_x = ({ let __tmp_x = ((*b.lock().unwrap()).as_ref().map(|__v| __v.len()).unwrap_or(0) as i32); let __tmp_y = ({ let __v = (*n.lock().unwrap().as_ref().unwrap()).clone(); __v } as i32); __tmp_x + __tmp_y } as i32); let __tmp_y = ((*b.lock().unwrap()).as_ref().map(|__v| __v.capacity()).unwrap_or(0) as i32); __tmp_x <= __tmp_y } {
        { let new_val = Arc::new(Mutex::new(Some({
            ...
            drop(__seq_guard);
            let __low = 0;
            let __high = ({ let __tmp_x = ((*b.lock().unwrap()).as_ref().map(|__v| __v.len()).unwrap_or(0) as i32); let __tmp_y = ({ let __v = (*n.lock().unwrap().as_ref().unwrap()).clone(); __v } as i32); __tmp_x + __tmp_y }) as usize;
            let __max = __source_cap;
    ...
    while { let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 10 as u64; __tmp_x >= __tmp_y } && { let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 0; __tmp_x > __tmp_y } {
        ...
        (*b.lock().unwrap().as_mut().unwrap())[({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize] = {
            let __f_ptr: *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync> = {
                let mut __f_guard = utod.lock().unwrap();
                __f_guard.as_mut().unwrap() as *mut Box<dyn FnMut(Arc<Mutex<Option<u64>>>) -> u8 + Send + Sync>
            };
            let __f = unsafe { &mut *__f_ptr };
            (*__f)(
                Arc::new(Mutex::new(Some({ let __tmp_x = { let __v = (*u.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = { let __tmp_x = { let __v = (*q.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 10 as u64; __tmp_x * __tmp_y }; __tmp_x - __tmp_y })))
            )
        };
...
pub fn append_nano(mut b: Arc<Mutex<Option<Vec<u8>>>>, nanosec: Arc<Mutex<Option<i32>>>, std: Arc<Mutex<Option<i32>>>) -> Arc<Mutex<Option<Vec<u8>>>> {
    ...
    if { let __tmp_x = n; let __tmp_y = 9; __tmp_x < __tmp_y } {
        { let new_val = Arc::new(Mutex::new(Some({
            ...
            drop(__seq_guard);
            let __low = 0;
            let __high = ({ let __tmp_x = ({ let __tmp_x = ((*b.lock().unwrap()).as_ref().map(|__v| __v.len()).unwrap_or(0) as i32); let __tmp_y = 9; __tmp_x - __tmp_y } as i32); let __tmp_y = (n as i32); __tmp_x + __tmp_y }) as usize;
            let __max = __source_cap;
            if __seq.len() < __high { __seq.resize_with(__high, Default::default); }
            let _slice = &__seq[__low..__high];
            let mut _v = Vec::with_capacity((__max - __low) as usize);
    ...
    if { let __v = (*trim.lock().unwrap().as_ref().unwrap()).clone(); __v } {
        while {
            let __go_cond_0 = { let __tmp_x = ((*b.lock().unwrap()).as_ref().map(|__v| __v.len()).unwrap_or(0) as i32); let __tmp_y = 0; __tmp_x > __tmp_y };
            if __go_cond_0 {
                let __go_cond_1 = {
        ...
        { let new_val = Arc::new(Mutex::new(Some({
            ...
            drop(__seq_guard);
            let __low = 0;
            let __high = ({ let __tmp_x = ((*b.lock().unwrap()).as_ref().map(|__v| __v.len()).unwrap_or(0) as i32); let __tmp_y = 1; __tmp_x - __tmp_y }) as usize;
            let __max = __source_cap;
            if __seq.len() < __high { __seq.resize_with(__high, Default::default); }
            let _slice = &__seq[__low..__high];
            let mut _v = Vec::with_capacity((__max - __low) as usize);
...
pub fn quote(s: Arc<Mutex<Option<String>>>) -> Arc<Mutex<Option<String>>> {
    ...
    while { let __tmp_x = { let __v = (*j.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = { let __v = (*width.lock().unwrap().as_ref().unwrap()).clone(); __v }; __tmp_x < __tmp_y } {
        ...
        { let new_val = { let __append_target = buf.clone(); (*__append_target.lock().unwrap()).get_or_insert_with(Vec::new).push({ let __s = &(LOWERHEX); __s.as_bytes()[({
            let __tmp_x = { let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = i as i32; let __tmp_y = { let __v = (*j.lock().unwrap().as_ref().unwrap()).clone(); __v }; __tmp_x + __tmp_y }) as usize] };
            let __tmp_y = 4;
            __tmp_x >> __tmp_y
        }) as usize] }); __append_target.clone() }; buf = new_val; };
        { let new_val = { let __append_target = buf.clone(); (*__append_target.lock().unwrap()).get_or_insert_with(Vec::new).push({ let __s = &(LOWERHEX); __s.as_bytes()[({
            let __tmp_x = { let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = i as i32; let __tmp_y = { let __v = (*j.lock().unwrap().as_ref().unwrap()).clone(); __v }; __tmp_x + __tmp_y }) as usize] };
            let __tmp_y = 0xF as u8;
            __tmp_x & __tmp_y
        }) as usize] }); __append_target.clone() }; buf = new_val; };
        { let mut guard = j.lock().unwrap(); *guard = Some(guard.as_ref().unwrap() + 1); }
    }
    ...
    if !is_digit::<String>(Arc::new(Mutex::new(Some({ let __arg_holder = s.clone(); let __arg_guard = __arg_holder.lock().unwrap(); (*__arg_guard.as_ref().unwrap()).clone() }))), Arc::new(Mutex::new(Some(1)))) {
        ...
        return (
            (*Arc::new(Mutex::new(Some(({
                let __tmp_x = { let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
                let __tmp_y = ('0' as i32) as u8;
                __tmp_x - __tmp_y
    ...
    return (
        {
            ...
            let __tmp_y = (*Arc::new(Mutex::new(Some(({
                let __tmp_x = { let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(1) as usize] };
                let __tmp_y = ('0' as i32) as u8;
                __tmp_x - __tmp_y
            }) as i32))).lock().unwrap().as_ref().unwrap());
            __tmp_x + __tmp_y
        },
        Arc::new(Mutex::new(Some({ let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); let __low = (2) as usize; __s[__low..].to_string() }))),
        Arc::new(Mutex::new(None))
    );
}
...
pub fn getnum3(s: Arc<Mutex<Option<String>>>, fixed: Arc<Mutex<Option<bool>>>) -> (i32, Arc<Mutex<Option<String>>>, Arc<Mutex<Option<Box<dyn StdError + Send + Sync>>>>) {
    ...
    while { let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 3; __tmp_x < __tmp_y } && is_digit::<String>(Arc::new(Mutex::new(Some({ let __arg_holder = s.clone(); let __arg_guard = __arg_holder.lock().unwrap(); (*__arg_guard.as_ref().unwrap()).clone() }))), Arc::new(Mutex::new(Some({ let __arg_holder = i.clone(); let __arg_guard = __arg_holder.lock().unwrap(); (*__arg_guard.as_ref().unwrap()).clone() })))) {
        { let new_val = {
            let __tmp_x = { let __tmp_x = { let __v = (*n.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 10; __tmp_x * __tmp_y };
            let __tmp_y = (*Arc::new(Mutex::new(Some(({
    ...
    return (
        ...
        Arc::new(Mutex::new(Some({ let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); let __low = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize; __s[__low..].to_string() }))),
        Arc::new(Mutex::new(None))
    );
}
...
pub fn cutspace(mut s: Arc<Mutex<Option<String>>>) -> Arc<Mutex<Option<String>>> {
    while {
        let __go_cond_0 = { let __tmp_x = ((*s.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 0; __tmp_x > __tmp_y };
        if __go_cond_0 {
            let __go_cond_1 = {
                let __tmp_x = { let __s = &((*s.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
...
pub fn skip(mut value: Arc<Mutex<Option<String>>>, mut prefix: Arc<Mutex<Option<String>>>) -> (Arc<Mutex<Option<String>>>, Arc<Mutex<Option<Box<dyn StdError + Send + Sync>>>>) {
    while { let __tmp_x = ((*prefix.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 0; __tmp_x > __tmp_y } {
        if {
            let __tmp_x = { let __s = &((*prefix.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
            let __tmp_y = (' ' as i32) as u8;
            __tmp_x == __tmp_y
        } {
        if {
            let __go_cond_0 = { let __tmp_x = ((*value.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 0; __tmp_x > __tmp_y };
            if __go_cond_0 {
                let __go_cond_1 = {
                    let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
                    let __tmp_y = (' ' as i32) as u8;
                    __tmp_x != __tmp_y
                };
                __go_cond_1
        ...
        if {
            ...
            if __go_cond_0 {
                ...
                let __go_cond_1 = {
                    let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
                    let __tmp_y = { let __s = &((*prefix.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
                    __tmp_x != __tmp_y
                };
                __go_cond_1
            }
...
pub fn parse_1(mut layout: Arc<Mutex<Option<String>>>, mut value: Arc<Mutex<Option<String>>>, defaultLocation: Arc<Mutex<Option<Location>>>, local: Arc<Mutex<Option<Location>>>) -> (Arc<Mutex<Option<crate::r#mod::Time>>>, Arc<Mutex<Option<Box<dyn StdError + Send + Sync>>>>) {
    ...
    loop {
        ...
        if !_matched && (_switch_val == 263 || _switch_val == 264 || _switch_val == 265) || _fallthrough {
            ...
            if {
                let __go_cond_0 = {
                    let __go_cond_1 = { let __tmp_x = std; let __tmp_y = 264; __tmp_x == __tmp_y };
                    if __go_cond_1 {
                        let __go_cond_2 = { let __tmp_x = ((*value.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 0; __tmp_x > __tmp_y };
                        __go_cond_2
                    } else {
                        false
                    }
    ...
    while { let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 2; __tmp_x < __tmp_y } {
        if {
            let __go_cond_0 = {
                let __go_cond_1 = { let __tmp_x = std; let __tmp_y = 522; __tmp_x == __tmp_y };
                if __go_cond_1 {
                    let __go_cond_2 = { let __tmp_x = ((*value.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 0; __tmp_x > __tmp_y };
                    __go_cond_2
                } else {
        ...
        break '__go_switch_2
            ...
            if {
                let __go_cond_0 = {
                    let __go_cond_1 = { let __tmp_x = ((*value.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 2; __tmp_x >= __tmp_y };
                    if __go_cond_1 {
                        let __go_cond_2 = comma_or_period(Arc::new(Mutex::new(Some({ let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] }))));
                        __go_cond_2
                    } else {
                        false
                    }
                ...
                if __go_cond_0 {
                    let __go_cond_3 = is_digit::<String>(Arc::new(Mutex::new(Some({ let __arg_holder = value.clone(); let __arg_guard = __arg_holder.lock().unwrap(); (*__arg_guard.as_ref().unwrap()).clone() }))), Arc::new(Mutex::new(Some(1))));
                    __go_cond_3
                } else {
                    false
                }
    ...
    if _switch_val == ("pm".to_string()) {
        ...
        if !_matched && (_switch_val == 24 || _switch_val == 26 || _switch_val == 27 || _switch_val == 25 || _switch_val == 28) || _fallthrough {
            ...
            _fallthrough = false;
            if {
                let __go_cond_0 = { let __tmp_x = ((*value.lock().unwrap().as_ref().unwrap()).len() as i32); let __tmp_y = 1; __tmp_x >= __tmp_y };
                if __go_cond_0 {
                    let __go_cond_1 = {
                        let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(0) as usize] };
        ...
        if {
            let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(3) as usize] };
            let __tmp_y = (':' as i32) as u8;
            __tmp_x != __tmp_y
        } {
        { let __rhs_holder = errBad.clone(); let new_val = { let mut guard = __rhs_holder.lock().unwrap(); guard.take() }; *err.lock().unwrap() = new_val; };
        ...
        if {
            ...
            if __go_cond_0 {
                ...
                let __go_cond_1 = {
                    let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(6) as usize] };
                    let __tmp_y = (':' as i32) as u8;
                    __tmp_x != __tmp_y
                };
                __go_cond_1
    ...
    if _switch_val == (('+' as i32) as u8) {
            ...
            if {
                let __go_cond_0 = {
                    ...
                    if __go_cond_1 {
                        ...
                        let __go_cond_4 = {
                            let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(1) as usize] };
                            let __tmp_y = ('0' as i32) as u8;
                            __tmp_x < __tmp_y
                        };
                        __go_cond_4
                ...
                if __go_cond_0 {
                    ...
                    let __go_cond_5 = {
                        let __tmp_x = ('9' as i32) as u8;
                        let __tmp_y = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(1) as usize] };
                        __tmp_x < __tmp_y
                    };
                    __go_cond_5
                }
        ...
        break '__go_switch_2
            ...
            while {
                let __go_cond_0 = {
                    let __go_cond_1 = { let __tmp_x = ({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y } as i32); let __tmp_y = ((*value.lock().unwrap().as_ref().unwrap()).len() as i32); __tmp_x < __tmp_y };
                    if __go_cond_1 {
                        let __go_cond_2 = {
                            let __tmp_x = ('0' as i32) as u8;
                            let __tmp_y = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                            __tmp_x <= __tmp_y
                        };
                        __go_cond_2
                    } else {
                ...
                if __go_cond_0 {
                    let __go_cond_3 = {
                        let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[({ let __tmp_x = { let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }; let __tmp_y = 1; __tmp_x + __tmp_y }) as usize] };
                        let __tmp_y = ('9' as i32) as u8;
                        __tmp_x <= __tmp_y
                    };
                    __go_cond_3
...
pub fn parse_time_zone(value: Arc<Mutex<Option<String>>>) -> (i32, bool) {
    ...
    if _switch_val == (0) || _switch_val == (1) || _switch_val == (2) || _switch_val == (6) {
            ...
            if {
                let __tmp_x = { let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); __s.as_bytes()[(4) as usize] };
                let __tmp_y = ('T' as i32) as u8;
                __tmp_x == __tmp_y
            } {
        return (5, true);
    }
            ...
            if {
                ...
                if __go_cond_0 {
                    ...
                    let __go_cond_1 = { let __tmp_x = (*Arc::new(Mutex::new(Some({ let __s = &((*value.lock().unwrap().as_ref().unwrap()).clone()); let __high = (4) as usize; __s[..__high].to_string() }))).lock().unwrap().as_ref().unwrap()).clone(); let __tmp_y = "WITA".to_string(); __tmp_x == __tmp_y };
                    __go_cond_1
                }
            } {
        return (4, true);
...
pub fn leading_int<bytes: GoByteSequence + Clone + Send + Sync + 'static>(s: Arc<Mutex<Option<bytes>>>) -> (u64, Arc<Mutex<Option<bytes>>>, Arc<Mutex<Option<Box<dyn StdError + Send + Sync>>>>) {
    ...
    while { let __tmp_x = ({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v } as i32); let __tmp_y = ((*s.lock().unwrap().as_ref().unwrap()).go_len() as i32); __tmp_x < __tmp_y } {
        ...
        // overflow
    return (
        { let __v = (*x.lock().unwrap().as_ref().unwrap()).clone(); __v },
        Arc::new(Mutex::new(Some((*s.lock().unwrap().as_ref().unwrap()).go_slice_to_string(({ let __v = (*i.lock().unwrap().as_ref().unwrap()).clone(); __v }) as usize, None)))),
        Arc::new(Mutex::new(None))
    );
}
