...
pub(crate) const DARWIN64_BIT: bool = (matches!(runtime::G_O_O_S, "darwin") || matches!(runtime::G_O_O_S, "ios")) && SIZEOF_PTR == 8;
pub(crate) const NETBSD32_BIT: bool = matches!(runtime::G_O_O_S, "netbsd") && SIZEOF_PTR == 4;
