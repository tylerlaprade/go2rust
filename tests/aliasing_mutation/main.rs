...
fn main() {
    ...
    println!("{} {}", "Initial: x =".to_string(), (*x.borrow().as_ref().unwrap()));
    ...
    println!("{} {}", "After *p = 100: x =".to_string(), (*x.borrow().as_ref().unwrap()));
    ...
    println!("{} {}", "After *q = 200: x =".to_string(), (*x.borrow().as_ref().unwrap()));
    ...
    println!("{} {}", "After x = 300: x =".to_string(), (*x.borrow().as_ref().unwrap()));
