...
fn main() {
    ...
    println!("{}", format!("{}", (*(*(*dst.borrow().as_ref().unwrap()).module.borrow().as_ref().unwrap()).path.borrow().as_ref().unwrap()).clone()));
    println!("{}", format!("{}", (*(*(*src.borrow().as_ref().unwrap()).module.borrow().as_ref().unwrap()).path.borrow().as_ref().unwrap()).clone()));
}