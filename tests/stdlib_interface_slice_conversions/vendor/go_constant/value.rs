...
use crate::{GoMutex, go_strconv_format_float, go_strconv_format_int};
...
impl Default for stringVal {
    fn default() -> Self {
        Self { mu: GoMutex::new(), s: Arc::new(Mutex::new(Some(String::new()))), l: Arc::new(Mutex::new(None)), r: Arc::new(Mutex::new(None)) }
    }
}
