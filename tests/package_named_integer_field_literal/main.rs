...
fn main() {
    ...
    println!("{}", (*example_com_namedfield_dep::enabled(cfg.clone(), Rc::new(RefCell::new(Some(example_com_namedfield_dep::LoadMode(Rc::new(RefCell::new(Some(example_com_namedfield_dep::NEED_FILES as i32)))))))).borrow().as_ref().unwrap()));
}