...
fn main() {
    ...
    println!("{} {} {} {} {} {}", format!("{}", (*chunks.borrow().as_ref().unwrap()).len()), format!("{}", (*chunks.borrow().as_ref().unwrap())[(0) as usize].clone().len()), format!("{}", (*chunks.borrow().as_ref().unwrap())[(0) as usize].clone()[(0) as usize].clone()), format!("{}", (*chunks.borrow().as_ref().unwrap())[(0) as usize].clone()[(1) as usize].clone()), format!("{}", (*chunks.borrow().as_ref().unwrap())[(1) as usize].clone().len()), format!("{}", (*chunks.borrow().as_ref().unwrap())[(1) as usize].clone()[(0) as usize].clone()));
}