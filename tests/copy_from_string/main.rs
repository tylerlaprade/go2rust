...
fn main() {
    ...
    println!("{} {}", { let __v = (*n.borrow().as_ref().unwrap()).clone(); __v }, (*Rc::new(RefCell::new(Some(String::from_utf8((*buf.borrow().as_ref().unwrap()).clone()).unwrap()))).borrow().as_ref().unwrap()));
    ...
    println!("{} {}", { let __v = (*n2.borrow().as_ref().unwrap()).clone(); __v }, (*Rc::new(RefCell::new(Some(String::from_utf8((*buf2.borrow().as_ref().unwrap()).clone()).unwrap()))).borrow().as_ref().unwrap()));
    ...
    println!("{} {}", { let __v = (*n4.borrow().as_ref().unwrap()).clone(); __v }, (*Rc::new(RefCell::new(Some(String::from_utf8((*buf3.borrow().as_ref().unwrap()).clone()).unwrap()))).borrow().as_ref().unwrap()));
}